...
CNINFO_SOURCE=${CNINFO_SOURCE:-/home/gaozh/llm_return/data/processed/cleaned/prompt_v2_masked_parts}
CNINFO_SHARDS_ROOT=${CNINFO_SHARDS_ROOT:-/mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/single_stock_cninfo_v1/prompt_positive_v1/cninfo_shards_1000}
OUTPUT_ROOT=${OUTPUT_ROOT:-/mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/single_stock_cninfo_v1/prompt_positive_v1/embeddings}
PROMPT_CONFIG=${PROMPT_CONFIG:-${REPO_ROOT}/configs/generated/positive_prompt_templates_v1.json}
mkdir -p "${OUTPUT_ROOT}" /mnt/lustre3/home/gaozh/llm_return/logs/positive_prompt_embeddings

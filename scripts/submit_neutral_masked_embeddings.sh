...
if [[ -z "${TASK_RECORD_ID:-}" ]]; then
  ...
  exec .venv/bin/python scripts/task_tracker.py run \
    ...
    --output /mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/neutral_masked_short_v1 \
...
ROOT=/mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/neutral_masked_short_v1
INPUT_ROOT=${INPUT_ROOT:-${ROOT}/inputs}
OUTPUT_ROOT=${OUTPUT_ROOT:-${ROOT}/embeddings}
CONFIG=${CONFIG:-/mnt/lustre3/home/gaozh/llm_return/configs/prompts/neutral_masked_short_v1.json}
...
SINA_CLEAN=/mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/cleaned_full_2010_2026/sina_all_news_clean_expanded.parquet
SINA_PANEL=/mnt/lustre3/home/gaozh/sina_all_news_records_2010_2026/classification/sina_full_classification_panel.parquet
CNINFO_CLEAN=/mnt/lustre3/home/gaozh/llm_return/data/processed/cleaned/cninfo_announcements_2010_2026_final.jsonl
CNINFO_PANEL=/mnt/lustre3/home/gaozh/llm_return/data/processed/cninfo_full_classification_panel_2010_2026.parquet
...
for dataset in sina cninfo; do
  for model in roberta bge_m3; do
    job=$(tracked sbatch --parsable \
      ...
      --export=ALL,DATASET=${dataset},MODEL=${model},REPO_ROOT=/mnt/lustre3/home/gaozh/llm_return,INPUT_ROOT=${INPUT_ROOT},OUTPUT_ROOT=${OUTPUT_ROOT},CONFIG=${CONFIG} \
